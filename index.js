...
function displayJoke2() {
    var joke = confirm("Press 'OK' if you would like to read a joke. \nOtherwise press 'Cancel'.");
    msg = joke ? "I'm thinking of reasons to go to Switzerland. The flag is a big plus." : "Ok. No jokes for you";
}
...
function favNumber(){
    ...
    if (num == null){
        ...
        alert("So your favorite number is " + num + "? Interesting...");
    }
...
function getUserInfo(){
    ...
    while (typeof firstName == 'number' || firstName == ''){
    ...
    while (typeof lastName == 'number' || lastName == ''){
...
function displayInfo(){
    if (firstName == null && lastName == null && num == null){
        alert("I learned you do not have a first or last name or a favorite number. Are you really a human?");
    } else if (firstName == null && lastName == null){
        alert("I learned you do not have a first or last name. Your favorite number is: " + currentUser.num);
    } else if (firstName == null && num == null){
        alert("I learned you do not have a first name or a favorite number. Your last name is: " + currentUser.lastName);
    } else if (lastName == null && num == null){
        alert("I learned you do not have a last name or a favorite number. Your first name is: " + currentUser.firstName);
    } else if (firstName == null){
        alert("I learned you do not have a first name. Your last name is: " + currentUser.lastName + ". Your favorite number is: " + currentUser.num);
    } else if (lastName == null){
        alert("I learned you do not have a last name. Your first name is: " + currentUser.first + ". Your favorite number is: " + currentUser.num);
    } else if (num == null) {
        alert("I learned you do not have a favorite number. Your name is: " + currentUser.firstName + + currentUser.lastName);
    } else{
        alert("I learned that your name is: " + currentUser.firstName + " " + currentUser.lastName + ". Your favorite number is: " + currentUser.num);
    }
}
